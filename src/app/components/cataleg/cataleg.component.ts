...
export class CatalegComponent {
  ...
  products: any[] = [
    ...
    {name: 'Galetes de llet condensada', id: 4, quantity: 1, image: 'assets/condensed-milk-cookies.jpg', gust: 'salada', pasta: 'tova', price: 9.99, description: '1kg de galetes de llet condensada de la marca Fornais'},
    {name: 'Galetes de chocolata', id: 5, quantity: 1, image: 'assets/chocolate-chip-cookies.jpg', gust: 'salada', pasta: 'dura', price: 12.99, description: '1kg de galetes de chocolata de la marca Fornais'},
    {name: 'Galetes de integrals', id: 6,  quantity: 1, image: 'assets/integral-cookies.jpg', gust: 'salada', pasta: 'liquida', price: 14.99, description: '1kg de galetes itegrals de la marca Fornais'}
  ];
